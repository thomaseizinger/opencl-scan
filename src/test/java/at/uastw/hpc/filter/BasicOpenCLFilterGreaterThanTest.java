...
public class BasicOpenCLFilterGreaterThanTest {
    ...
    @Test
    @Parameters
    public void shouldFilterGreaterThan(int threshold, int[] source) throws Exception {
    ...
    public Object[] parametersForShouldFilterGreaterThan() {
